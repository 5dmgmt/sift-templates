...
4. 受講者に「積み残しのうち、特に意識して持ち越したいもの」を 1 問だけ聞く (件数は問わない / 該当なしも genuine)
...
- **最大の成果** (件数は問わない / 該当なしも genuine、エビデンス引用元付き)
- **最大の変化** (件数は問わない / 該当なしも genuine、エビデンス引用元付き)
- **Workshop への期待**: 1〜2 行
...
- フォーマット: 直近の期限 + カテゴリ別 + 特に意識して持ち越したいもの (件数は問わない / 該当なしも genuine) + 各 Course の X053 持ち越し参照リンク
...
### 特に意識して持ち越したいもの (件数は問わない / 該当なしも genuine)
-
